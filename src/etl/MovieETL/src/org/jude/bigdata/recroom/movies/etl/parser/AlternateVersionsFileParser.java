 ...
 * 
 */
public class AlternateVersionsFileParser extends MultilineFileParser {
	static final String SOURCE_NAME = "alternate-versions";
	static final String PRE_HEADER_LINE = "ftp.sunet.se  in  /pub/tv+movies/imdb/tools/w32/";
	static final String HEADER_LINE = "=======================";
	static final String END_LINE = "-------------------------";

	Logger logger = Logger.getLogger(AlternateVersionsFileParser.class);
	 ...
	 * @param path
	 */
	public AlternateVersionsFileParser(String path) {
