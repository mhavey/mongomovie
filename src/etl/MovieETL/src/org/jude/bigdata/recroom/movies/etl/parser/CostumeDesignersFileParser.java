 ...
 * 
 */
public class CostumeDesignersFileParser extends RoleFileParser {
	static final String SOURCE_NAME = "costume-designers";
	static final String PRE_HEADER_LINE = "Name\t\t\tTitles";
	static final String HEADER_LINE = "----			------";
	static final String END_LINE = "---------------------";

	Logger logger = Logger.getLogger(CostumeDesignersFileParser.class);
	 ...
	 * @param path
	 */
	public CostumeDesignersFileParser(String path) {
