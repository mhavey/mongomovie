 ...
 * 
 */
public class ComposersFileParser extends RoleFileParser {
	static final String SOURCE_NAME = "composers";
	static final String PRE_HEADER_LINE = "Name\t\t\tTitles";
	static final String HEADER_LINE = "----			------";
	static final String END_LINE = "---------------------";

	Logger logger = Logger.getLogger(ComposersFileParser.class);
	 ...
	 * @param path
	 */
	public ComposersFileParser(String path) {
